...
public enum GameEvent {
    ...
    TreeHype("Tree hype!", "The latest trend is living near trees!", 0.4f, "TreeHype.png"),
    RockClimbing("Rock climbing", "Rock climbing is the sport of the year! Students want to live near rocks.", 0.1f, "RockClimbing.png"),
    LectureView("A pleasant view","Students want nice scenery to look at while \"focusing\" in lectures.", 0.7f, "LectureView.png"),
    TooManyBuildings("Too many buildings!", "Nobody can remember where they're supposed to be!", 0.2f, "TooManyBuildings.png"),
    GymHype("Upcoming tournament", "Everyone wants to practise in the gym for the big game", 0.4f, "GymHype.png"),
    TournamentWon("Our team won!", "The university is victorious in the tournament!", 0.5f, "TournamentWon.png"),
